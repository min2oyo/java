package s01_array.EX09_ReadArrayData_2D;
...
public class ReadArrayData_2D {
	...
	public static void main(String[] args) {
		...
		System.out.println(array2[0].length);	// 2 // 첫 번째 행이 가리키는 1차원 배열의 개수
		System.out.println(array2[1].length);	// 3 // 두 번째 행이 가리키는 1차원 배열의 개수
		System.out.println();
