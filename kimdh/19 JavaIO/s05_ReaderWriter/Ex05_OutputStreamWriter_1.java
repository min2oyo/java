...
public class Ex05_OutputStreamWriter_1 {
	...
	public static void main(String[] args) {
		...
		File outputStreamWriter1 = new File("files/OutputStreamWiter1.txt");
		...
		File outputStreamWriter2 = new File("files/OutputStreamWiter2.txt");

		try (OutputStream os = new FileOutputStream(outputStreamWriter2, false); OutputStreamWriter osw = new OutputStreamWriter(os, "MS949");) {
