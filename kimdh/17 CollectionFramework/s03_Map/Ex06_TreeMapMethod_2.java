...
public class Ex06_TreeMapMethod_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println(treeMap1.toString()); // {10=나라다, 20=가나다}
		...
		// 3. MyClass 객체 크기 비교
		/*
		 * TreeMap<MyClass, String> treeMap3 = new TreeMap<MyClass, String>(); MyClass myClass1 = new MyClass(2, 5); MyClass myClass2 = new MyClass(3, 3); treeMap3.put(myClass1, "가나다"); treeMap3.put(myClass2, "나라다"); System.out.println(treeMap3.toString());
		 */
		...
		System.out.println(treeMap4);	// {data1=2을 가지고 있는 클래스=가나다, data1=3을 가지고 있는 클래스=나라다}
		...
		System.out.println(treeMap5);	// {data1=2을 가지고 있는 클래스=가나다, data1=3을 가지고 있는 클래스=나라다}
